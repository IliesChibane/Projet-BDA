...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.MainWindow.resize(775, 585)
...
"font: 75 12pt \"Arial\";")
        ...
        self.MainWindow.setWindowIcon(QtGui.QIcon('bdd.png')) 
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.clicked.connect(quitter)
        self.pushButton_3.clicked.connect(lambda : minimizer(MainWindow))
        self.pushButton_5.clicked.connect(lambda : qst1(self.plainTextEdit, self.textEdit))
        self.pushButton_6.clicked.connect(lambda : qst2(self.plainTextEdit, self.textEdit))
        self.pushButton_7.clicked.connect(lambda : qst3(self.plainTextEdit, self.textEdit))
        self.pushButton_8.clicked.connect(lambda : qst4(self.plainTextEdit, self.textEdit))
        self.pushButton_9.clicked.connect(lambda : qst5(self.plainTextEdit, self.textEdit))
        self.pushButton_10.clicked.connect(lambda : qst6(self.plainTextEdit, self.textEdit))
        self.pushButton_11.clicked.connect(lambda : qst7(self.plainTextEdit, self.textEdit))
        self.pushButton_12.clicked.connect(lambda : qst8(self.plainTextEdit, self.textEdit))
        self.pushButton_13.clicked.connect(lambda : qst9(self.plainTextEdit, self.textEdit))
        self.pushButton_14.clicked.connect(lambda : qst10(self.plainTextEdit, self.textEdit))
        self.pushButton_15.clicked.connect(lambda : qst11(self.plainTextEdit, self.textEdit))
        self.pushButton_16.clicked.connect(lambda : qst12(self.plainTextEdit, self.textEdit))
        self.pushButton_17.clicked.connect(lambda : qst13(self.plainTextEdit, self.textEdit))
        self.pushButton_18.clicked.connect(lambda : qst14(self.plainTextEdit, self.textEdit))
        self.pushButton_19.clicked.connect(lambda : qst15(self.plainTextEdit, self.textEdit))
